(()=>{if("object"==typeof Breinify&&!Breinify.plugins._isAdded("uiSurvey")){let o="br-ui-survey",u="br-ui-survey-popup",n=Breinify.UTL._jquery();class a extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this._renderBase()}_renderBase(){0<this.shadowRoot.childNodes.length||(this.shadowRoot.innerHTML=`
                <style>
                    :host {
                        display: none;
                        position: fixed;
            ...
            </style>`))}_createTrigger(){var e=this.settings&&this.settings.trigger||{},i=e.bannerUrl,e=e.mobileBannerUrl||i,r=n("<div/>",{class:"br-ui-survey-trigger",role:"button",tabindex:0,"aria-label":"Start survey"});return i&&r.append(n('<img src="'+i+'" class="br-ui-survey-trigger-image" alt="Start survey"/>').addClass("br-ui-survey-desktop")),e&&r.append(n('<img src="'+e+'" class="br-ui-survey-trigger-image" alt="Start survey"/>').addClass("br-ui-survey-mobile")),r.on("click",e=>{e.preventDefault(),this._openSurvey()}),r}_openSurvey(){let e=document.querySelector(u);e||(e=document.createElement(u),document.body.appendChild(e)),e.open(),console.log("Survey trigger clicked:",this.uuid)}render(e,i){this.settings=i,this.uuid=e,this.$shadowRoot.empty(),this._ensureBaseStyle(),Breinify.plugins.webExperiences.style(this.settings,this.$shadowRoot);var i=n('<div class="br-ui-survey-root"></div>'),r=this._createTrigger();i.append(r),this.$shadowRoot.append(i),console.log(e),console.log(this.settings),console.log(JSON.stringify(this.settings))}}Breinify.plugins._add("uiSurvey",{register:function(e,i,r){window.customElements.get(u)||window.customElements.define(u,a),window.customElements.get(o)||window.customElements.define(o,d);var t="br-survey-"+i;let s=n("#"+t);0===s.length&&(s=n("<"+o+"/>").attr("id",t),!1===Breinify.plugins.webExperiences.attach(r,s))||s.get(0).render(i,r)}})}})();