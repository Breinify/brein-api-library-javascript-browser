(()=>{if("object"==typeof Breinify&&!Breinify.plugins._isAdded("uiSurvey")){let o="br-ui-survey",a="br-ui-survey-popup",h=Breinify.UTL._jquery(),r=null,s=!1;class l extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.closeOnBackgroundClick=!1,this.resetOnClose=!0,this._renderBase()}_renderBase(){0<this.shadowRoot.childNodes.length||(this.shadowRoot.innerHTML=`
                <style>
                    /* -------------------------------------------------- */
