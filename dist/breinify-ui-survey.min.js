(()=>{if("object"==typeof Breinify&&!Breinify.plugins._isAdded("uiSurvey")){let o="br-ui-survey",a="br-ui-survey-popup",h=Breinify.UTL._jquery();class d extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.closeOnBackgroundClick=!1,this.resetOnClose=!0}render(e){0<this.shadowRoot.childNodes.length||(this.shadowRoot.innerHTML=`
                <style>
                    /* -------------------------------------------------- */
            ...
            `,Breinify.plugins.webExperiences.style(e,h(this.shadowRoot)),this._bindBaseEvents())}_ensurePageStyle(){return`
                :host {
