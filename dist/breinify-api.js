...
;
    ...
    Breinify.service = function (payload, user, onReady) {
        if (typeof onReady === 'function') {
            onReady();
        }
    };
    ...
    Breinify.UTL = {
        ...
        dom: {
            isNodeType: function(el, nodeTypes) { return false; },
            getTagName: function($el) { return 'no tag'; },
            ...
            applyContentByOperation: function() { return false; },
        },
        google: {
