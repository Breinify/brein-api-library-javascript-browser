        ...
        uglify: {
            ...
            plugins: {
                files: {
                    ...
                    'dist/breinify-placement-manager.min.js': 'src/plugins/PlacementManager.js',
                    'dist/breinify-journey.min.js': 'src/plugins/Journey.js',
                    'dist/breinify-feature-storage.min.js': 'src/plugins/FeatureStorage.js',
                    ...
                    'dist/breinify-ui-custom-elements.min.js': 'src/plugins/UiCustomElements.js',
                    ...
                    'dist/breinify-ui-modify-content.min.js': 'src/plugins/UiModifyContent.js',
        ...
        copy: {
            ...
            plugins: {
                files: [
                    ...
                    {expand: true, cwd: 'src/plugins', src: 'PlacementManager.js', dest: 'dist', rename: function(dest) { return dest + '/breinify-placement-manager.js' } },
                    ...
                    {expand: true, cwd: 'src/plugins', src: 'FeatureStorage.js', dest: 'dist', rename: function(dest) { return dest + '/breinify-feature-storage.js' } },
                    ...
                    {expand: true, cwd: 'src/plugins', src: 'UiCustomElements.js', dest: 'dist', rename: function(dest) { return dest + '/breinify-ui-custom-elements.js' } },
                    ...
                    {expand: true, cwd: 'src/plugins', src: 'UiModifyContent.js', dest: 'dist', rename: function(dest) { return dest + '/breinify-ui-modify-content.js' } },
